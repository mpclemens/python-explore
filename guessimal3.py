...
class Guessimal:
	...
	def __init__(self,file_name="guessimal3.data"):
		self.root_node = Node.load_tree(file_name)

	# Centralized y/n handler, since Python 2 and 3 handle this differently
	...
	# Change this method too, for Python 2 vs. 3
...
""")
		...
		print("Now I need to know what makes", animal_text, "different from", wrong_animal.text, end=".")
